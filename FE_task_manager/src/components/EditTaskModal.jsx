  ...
  return (
    ...
    >
      <section
        ...
        aria-describedby={errors.form ? "edit-task-form-error" : undefined}
        onClick={(event) => event.stopPropagation()}
      >
        <div className="flex items-start justify-between gap-4 mb-4">
          <h2 id="edit-task-modal-title" className="text-lg sm:text-xl font-bold">
            Edit Task
          </h2>
        ...
        <form onSubmit={handleSubmit} noValidate>
          <div className="mb-4">
            ...
            />
            {errors.title && (
              <p id="edit-title-error" className="text-red-700 text-sm mt-1" role="alert">
                {errors.title}
              </p>
            )}
          </div>
          ...
          {errors.form && (
            <p id="edit-task-form-error" className="text-red-700 text-sm mb-4" role="alert">
              {errors.form}
            </p>
          )}
